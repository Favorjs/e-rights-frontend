      ...
      <div className="container-custom py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
          ...
          <div className="flex items-center bg-white border border-slate-200 px-4 py-2 rounded-full text-xs font-bold text-slate-500 shadow-sm">
            <span className="text-emerald-600 uppercase tracking-widest">Verified Record</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
          ...
          <div className="lg:col-span-8 order-2 lg:order-1">
            <div className="card shadow-sm">
              <div className="card-header bg-white flex items-center justify-between">
                ...
                <span className="status-badge status-completed text-[10px]">Verified Account</span>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-12">
                  <div className="space-y-8">
                    <div className="group">
                      ...
                      <p className="text-xl font-bold text-slate-900 bg-slate-50 p-3 rounded-md border border-slate-100 group-hover:bg-white group-hover:border-emerald-200 transition-all">
                    ...
                    <div className="group">
                      ...
                      <p className="text-xl font-bold text-slate-900 border-l-4 border-l-emerald-600 pl-4 py-1">
                        {shareholder.name}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-8">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-emerald-700 text-right">{shareholder.rights_issue.toLocaleString()}</p>
                      </div>
                    </div>

                    <div className="bg-emerald-900 text-white rounded-xl p-6 shadow-lg shadow-emerald-500/10">
                      <label className="text-[10px] font-bold text-emerald-300 uppercase tracking-[0.2em] mb-3 block">Total Payable Amount</label>
                      <div className="flex items-baseline space-x-2">
                        <span className="text-sm font-bold text-emerald-400">NGN</span>
                        <span className="text-3xl font-extrabold">{shareholder.amount_due.toLocaleString()}</span>
                      </div>
                      <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                        <span className="text-xs text-emerald-300">Target Holdings</span>
            ...
            <div className="mt-8 p-6 bg-slate-900 rounded-xl flex items-start space-x-5 text-white shadow-xl">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm leading-relaxed max-w-xl">
                  ...
                  Reach out to <a href="mailto:registrars@apel.ng" className="text-emerald-400 hover:underline">registrars@apel.ng</a> referencing your Registration ID.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6 order-1 lg:order-2">
            ...
            <div className="card shadow-md border-emerald-600 bg-white group hover:shadow-xl transition-all h-full flex flex-col">
              <div className="p-1 uppercase text-[9px] font-extrabold tracking-[0.3em] text-white bg-emerald-700 text-center rounded-t-sm">
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <div className="space-y-4 mb-10 mt-auto">
                  {[
                    ...
                    <div key={i} className="flex items-center text-xs font-bold text-slate-700">
                      <div className="w-4 h-4 rounded-full bg-emerald-100 flex items-center justify-center mr-3">
                ...
                <Link
                  ...
                  className="btn-primary w-full py-4 text-base font-bold tracking-wide shadow-emerald-500/20 shadow-lg"
                >
                  START SECURE PORTAL
                </Link>
              </div>
